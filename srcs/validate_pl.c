...
/*   Updated: 2021/03/24 18:53:30 by galves-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**    validate_pl
** Description:
**    Validate each plane's (pl) arguments and parameters
...
**                  (i.e. a different plane) of the file. At the second
**                  index (pl[index1][index2]) is a word (string) of the
**                  respective line
** Return:
**    t_error -> report the error found
**       [NO_ERROR] :: everything is alright
**       [WRONG_NUM_ARGS_PL] :: wrong number of arguments passed
**       [BAD_FORMAT_PL] :: some argument has a wrong number of parameters
**       [WRONG_ARGS_RANGE_PL] :: parameter of some argument is out of range
*/
